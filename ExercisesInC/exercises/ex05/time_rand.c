...
// the standard method for generating random floats is faster on my machine by 100 ms
// the standard method for generating random doubles was faster by 10 ms
